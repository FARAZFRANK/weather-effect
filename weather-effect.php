...
define( 'AWPLIFE_WE_VERSION', '1.6.1' );
...
function awplife_we_enqueue_scripts() {
    ...
    $enable_weather_effect = isset( $weather_effect_settings['enable_weather_effect'] ) ? $weather_effect_settings['enable_weather_effect'] : 0;
