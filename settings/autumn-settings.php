...
<div id="autumn_weather_effect" class="tab-content">
	<div id="autumn_effect_sh">
		<p class="wep-section-heading"><?php esc_html_e( 'Autumn Effect Settings', 'weather-effect' ); ?></p>
		<div>
			<div class="checkbox">
				<label>
					<?php
			...
			<div class="autumn_leaf_sh">
				...
				?>
				<select id="autumn_leaf" name="autumn_leaf" class="form-control">
	...
	jQuery(document).ready(function(){
		<?php if ( $leaf == 'leaf' ) { ?>
			snowFall.snow(document.body, {
				image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/autumn/' . $autumn_leaf . '.png' ); ?>",
