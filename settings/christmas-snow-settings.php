...
<?php wp_enqueue_script( 'Christmas-checkbox-hide-show-settings', AWPLIFE_WE_PLUGIN_PATH . 'assets/js/christmas-checkbox-hide-show-settings.js', array( 'jquery' ), '1.6.1', true ); ?>
<!-- Christmas Falls Settings -->
<div id="christmas_weather_effect" class="tab-content">
	<p class="wep-section-heading"><?php esc_html_e( 'Christmas Fall Types', 'weather-effect' ); ?></p>
	<?php
	...
	<div id="snow_effect_sh">
		...
		<div>
			...
			<div class="christmas_balls_sh">
				...
				?>
				<select id="christmas_ball" name="christmas_ball" class="form-control">
					<option value="ball1" 
					<?php
		...
		<div>
			...
			<div class="christmas_bells_sh">
				...
				?>
				<select id="christmas_bell" name="christmas_bell" class="form-control">
					<option value="bell1" 
					<?php
		...
		<div>
			...
			<div class="christmas_candy_sh">
				...
				?>
				<select id="christmas_candy" name="christmas_candy" class="form-control">
					<option value="candy1" 
					<?php
		...
		<div>
			...
			<div class="christmas_gift_sh">
				...
				?>
				<select id="christmas_gift" name="christmas_gift" class="form-control">
					<option value="gift1" 
					<?php
		...
		<div>
			...
			<div class="christmas_snowman_sh">
				...
				?>
				<select id="christmas_snowman" name="christmas_snowman" class="form-control">
		...
		<div>
			...
			<div class="christmas_snow_flake_sh">
				...
				?>
				<select id="christmas_snow_flake" name="christmas_snow_flake" class="form-control">
					<option value="flack1" 
					<?php
	...
	<div id="snow_master_sh">
		...
		<div class="round_hide_show">
			<div class="row">
				<div class="col-md-6">
					<div class="row">
						<label class="bg_lower_label"><?php esc_html_e( '1. Fall Type', 'weather-effect' ); ?></label>
						<?php
		...
		<div class="row">
			<label class="bg_lower_label"><?php esc_html_e( 'B. Shadows Type', 'weather-effect' ); ?></label>
			<?php
		...
		<div class="shadow_hide_show">
			<div class="row">
				<div class="col-md-6">
					<div class="row">
						<label class="bg_lower_label"><?php esc_html_e( '1. Show Falls Shadow', 'weather-effect' ); ?></label>
						<?php
			...
			jQuery(document).ready(function(){
				<?php if ( $ball == 'ball' ) { ?>
					snowFall.snow(document.body, {
						image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/christmas/' . $christmas_ball . '.png' ); ?>",
				...
				<?php if ( $bell == 'bell' ) { ?>
				snowFall.snow(document.body, {
					image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/christmas/' . $christmas_bell . '.png' ); ?>",
					minSize: <?php echo esc_js( $christmas_min_size_leaf ); ?>,
					maxSize: <?php echo esc_js( $christmas_max_size_leaf ); ?>,
					flakeCount: <?php echo esc_js( $christmas_flakes_leaf ); ?>,
					maxSpeed: <?php echo esc_js( $christmas_speed ); ?>
				...
				<?php if ( $candy == 'candy' ) { ?>
				snowFall.snow(document.body, {
					image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/christmas/' . $christmas_candy . '.png' ); ?>",
					minSize: <?php echo esc_js( $christmas_min_size_leaf ); ?>,
					maxSize: <?php echo esc_js( $christmas_max_size_leaf ); ?>,
					flakeCount: <?php echo esc_js( $christmas_flakes_leaf ); ?>,
					maxSpeed: <?php echo esc_js( $christmas_speed ); ?>
				...
				<?php if ( $gift == 'gift' ) { ?>
					snowFall.snow(document.body, {
					image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/christmas/' . $christmas_gift . '.png' ); ?>",
					minSize: <?php echo esc_js( $christmas_min_size_leaf ); ?>,
					maxSize: <?php echo esc_js( $christmas_max_size_leaf ); ?>,
					flakeCount: <?php echo esc_js( $christmas_flakes_leaf ); ?>,
					maxSpeed: <?php echo esc_js( $christmas_speed ); ?>
				...
				<?php if ( $snowman == 'snowman' ) { ?>
					snowFall.snow(document.body, {
						image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/christmas/' . $christmas_snowman . '.png' ); ?>",
						minSize: <?php echo esc_js( $christmas_min_size_leaf ); ?>,
						maxSize: <?php echo esc_js( $christmas_max_size_leaf ); ?>,
						flakeCount: <?php echo esc_js( $christmas_flakes_leaf ); ?>,
						maxSpeed: <?php echo esc_js( $christmas_speed ); ?>
				...
				<?php if ( $snow_flake == 'snow_flake' ) { ?>
					snowFall.snow(document.body, {
						image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/christmas/' . $christmas_snow_flake . '.png' ); ?>",
						minSize: <?php echo esc_js( $christmas_min_size_leaf ); ?>,
						maxSize: <?php echo esc_js( $christmas_max_size_leaf ); ?>,
						flakeCount: <?php echo esc_js( $christmas_flakes_leaf ); ?>,
						maxSpeed: <?php echo esc_js( $christmas_speed ); ?>
