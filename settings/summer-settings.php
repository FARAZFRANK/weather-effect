...
<div id="summer_weather_effect" class="tab-content">
	<div id="summer_effect_sh">
		<p class="wep-section-heading"><?php esc_html_e( 'Summer Effect Settings', 'weather-effect' ); ?></p>
		<div>
			<div class="checkbox">
				<label>
					<?php
			...
			<div class="summer_drink_sh">
				<div>
					...
					?>
					<select id="summer_drink" name="summer_drink" class="form-control">
						<option value="drink1" 
						<?php
		...
		<div>	
			...
			<div class="summer_sun_sh">
				...
				?>
				<select id="summer_sun" name="summer_sun" class="form-control">
					<option value="sun1" 
					<?php
					if ( $summer_sun == 'sun1' ) {
						echo 'selected="selected"';}
		...
		jQuery(document).ready(function(){
			<?php if ( $drink == 'drink' ) { ?>
				snowFall.snow(document.body, {
					image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/summer/' . $summer_drink . '.png' ); ?>",
			...
			<?php if ( $sun == 'sun' ) { ?>
				snowFall.snow(document.body, {
					image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/summer/' . $summer_sun . '.png' ); ?>",
					minSize: <?php echo esc_js( $summer_min_size_leaf ); ?>, 
					maxSize: <?php echo esc_js( $summer_max_size_leaf ); ?>,
					flakeCount: <?php echo esc_js( $summer_flakes_leaf ); ?>,
					maxSpeed: <?php echo esc_js( $summer_speed ); ?>
