...
<div id="thanksgiving_weather_effect" class="tab-content">
	<div id="thanksgiving_effect_sh">
		<p class="wep-section-heading"><?php esc_html_e( 'Thanks Giving Effect Settings', 'weather-effect' ); ?></p>
		<div>
			<div class="checkbox">
				<label>
					<?php
			...
			<div class="thanksgiving_turkey_sh">
				<div>
					...
					?>
					<select id="thanksgiving_turkey" name="thanksgiving_turkey" class="form-control">
	...
	jQuery(document).ready(function(){
		<?php if ( $turkey == 'turkey' ) { ?>
			snowFall.snow(document.body, {
				image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/thanksgiving/' . $thanksgiving_turkey . '.png' ); ?>",
