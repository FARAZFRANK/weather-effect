...
<div id="rain_weather_effect" class="tab-content">
	<div id="rain_effect_sh">
		<p class="wep-section-heading"><?php esc_html_e( 'Rain Effect Settings', 'weather-effect' ); ?></p>
		<div>
			<div class="checkbox">
				<label>
					<?php
			...
			<div class="rain_umbrella_sh">
				<div>
					...
					?>
					<select id="rain_umbrella" name="rain_umbrella" class="form-control">
		...
		<div>	
			...
			<div class="rain_drops_sh">
				...
				?>
				<select id="rain_drops" name="rain_drops" class="form-control">
					<option value="drops1" 
					<?php
		...
		<div>	
			...
			<div class="rain_cloud_sh">
				...
				?>
				<select id="rain_cloud" name="rain_cloud" class="form-control">
					<option value="cloud1" 
					<?php
...
jQuery(document).ready(function(){
	<?php if ( $umbrella == 'umbrella' ) { ?>
		snowFall.snow(document.body, {
			image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/rain/' . $rain_umbrella . '.png' ); ?>",
	...
	<?php if ( $drop == 'drop' ) { ?>
		snowFall.snow(document.body, {
			image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/rain/' . $rain_drops . '.png' ); ?>",
			minSize: <?php echo esc_js( $rain_min_size_leaf ); ?>, 
			maxSize: <?php echo esc_js( $rain_max_size_leaf ); ?>,
			flakeCount: <?php echo esc_js( $rain_flakes_leaf ); ?>,
			maxSpeed: <?php echo esc_js( $rain_speed ); ?>
	...
	<?php if ( $cloud == 'cloud' ) { ?>
		snowFall.snow(document.body, {
			image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/rain/' . $rain_cloud . '.png' ); ?>",
			minSize: <?php echo esc_js( $rain_min_size_leaf ); ?>, 
			maxSize: <?php echo esc_js( $rain_max_size_leaf ); ?>,
			flakeCount: <?php echo esc_js( $rain_flakes_leaf ); ?>,
			maxSpeed: <?php echo esc_js( $rain_speed ); ?>
