...
<div id="new_year_weather_effect" class="tab-content">
	<div id="new_year_effect_sh">
		<p class="wep-section-heading"><?php esc_html_e( 'New Year Effect Settings', 'weather-effect' ); ?></p>
		<div>
			<div class="checkbox">
				<label>
					<?php
			...
			<div class="new_year_balloon_sh">
				<div>
					...
					?>
					<select id="newyear_balloon" name="newyear_balloon" class="form-control">
		...
		<div>
			...
			<div class="new_year_sticker_sh">
				<div>
					...
					?>
					<select id="new_year_sticker" name="new_year_sticker" class="form-control">
...
jQuery(document).ready(function(){
	<?php if ( $balloon_new == 'balloon_new' ) { ?>
		snowFall.snow(document.body, {
			image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/newyear/' . $newyear_balloon . '.png' ); ?>",
	...
	<?php if ( $sticker == 'sticker' ) { ?>
		snowFall.snow(document.body, {
			image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/newyear/' . $new_year_sticker . '.png' ); ?>",
			minSize: <?php echo esc_js( $newyear_min_size_leaf ); ?>,
			maxSize: <?php echo esc_js( $newyear_max_size_leaf ); ?>,
			flakeCount: <?php echo esc_js( $newyear_flakes_leaf ); ?>,
			maxSpeed: <?php echo esc_js( $newyear_speed ); ?>
