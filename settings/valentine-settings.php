...
<div id="valentine_weather_effect" class="tab-content">
	<div id="valentine_effect_sh">
		<p class="wep-section-heading"><?php esc_html_e( 'Valentine Effect Settings', 'weather-effect' ); ?></p>
		<div>
			<div class="checkbox">
				<label>
					<?php
			...
			<div class="valentine_rose_sh">
				<div>
					...
					?>
					<select id="valentine_rose" name="valentine_rose" class="form-control">
						<option value="rose1" 
						<?php
		...
		<div>
			...
			<div class="valentine_balloon_sh">
				<div>
					...
					?>
					<select id="valentine_balloon" name="valentine_balloon" class="form-control">
		...
		<div>
			...
			<div class="valentine_heart_sh">
				<div>
					...
					?>
					<select id="valentine_heart" name="valentine_heart" class="form-control">
...
jQuery(document).ready(function(){
	<?php if ( $rose == 'rose' ) { ?>
		snowFall.snow(document.body, {
			image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/valentine/' . $valentine_rose . '.png' ); ?>",
	...
	<?php if ( $balloon == 'balloon' ) { ?>
		snowFall.snow(document.body, {
			image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/valentine/' . $valentine_balloon . '.png' ); ?>",
			minSize: <?php echo esc_js( $valentine_min_size_leaf ); ?>, 
			maxSize: <?php echo esc_js( $valentine_max_size_leaf ); ?>,
			flakeCount: <?php echo esc_js( $valentine_flakes_leaf ); ?>,
			maxSpeed: <?php echo esc_js( $valentine_speed ); ?>
	...
	<?php if ( $heart == 'heart' ) { ?>
		snowFall.snow(document.body, {
			image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/valentine/' . $valentine_heart . '.png' ); ?>",
			minSize: <?php echo esc_js( $valentine_min_size_leaf ); ?>, 
			maxSize: <?php echo esc_js( $valentine_max_size_leaf ); ?>,
			flakeCount: <?php echo esc_js( $valentine_flakes_leaf ); ?>,
			maxSpeed: <?php echo esc_js( $valentine_speed ); ?>
