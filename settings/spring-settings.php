...
<div id="spring_weather_effect" class="tab-content">
	<div id="spring_effect_sh">
		<p class="wep-section-heading"><?php esc_html_e( 'Spring Effect Settings', 'weather-effect' ); ?></p>
		<div>
			<div class="checkbox">
				<label>
					<?php
			...
			<div class="spring_leaf_sh">
				...
				?>
				<select id="spring_leaf" name="spring_leaf" class="form-control">
...
jQuery(document).ready(function(){
	<?php if ( $leaf_spring == 'leaf_spring' ) { ?>
		snowFall.snow(document.body, {
			image : "<?php echo esc_url( plugin_dir_url( __FILE__ ) . '../assets/images/spring/' . $spring_leaf . '.png' ); ?>",
